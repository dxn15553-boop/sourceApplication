  ...
  return (
    <div className="card glass-strong" style={{ borderTop: '4px solid var(--accent)' }}>
      ...
      <p style={{ fontSize: 13, color: 'var(--text-secondary)', marginBottom: 20 }}>
        Your Head of Department has approved this request. Please select all applicable departments (EHS, Admin, QA, Legal, etc.) that need to review this request before it proceeds to the Regional Coordinator. If no cross-functional reviews are needed, you can skip this step.
      </p>
