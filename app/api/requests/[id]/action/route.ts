...
const TRANSITIONS: Record<string, {
  ...
  'approve:final_head': { allowedRoles: ['final_head'], allowedStatuses: ['HOD Approved', 'Final Head Review', 'Under Required Review'], nextStatus: 'Final Head Approved', nextRole: 'procurement_manager', requiresComment: false },
  'reject:final_head': { allowedRoles: ['final_head'], allowedStatuses: ['HOD Approved', 'Final Head Review', 'Under Required Review'], nextStatus: 'Final Head Rejected', nextRole: null, requiresComment: true },
  'return:final_head': { allowedRoles: ['final_head'], allowedStatuses: ['HOD Approved', 'Final Head Review', 'Under Required Review'], nextStatus: 'Final Head Returned', nextRole: 'user', requiresComment: true },
